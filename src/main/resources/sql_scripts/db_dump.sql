...
INSERT INTO `genre` VALUES (1,'Action'),(2,'Adventure'),(3,'Horror'),(4,'Drama'),(5,'Romance'),(6,'Thriller'),(7,'Comedy'),(8,'Mystery'),(10,'tohleNeniDobryGenreTest'),(12,'test');
...
INSERT INTO `movie_has_genre` VALUES (9,1),(12,1),(12,2),(9,4),(11,4),(9,5),(11,5);
...
INSERT INTO `review` VALUES (4,1,11,'docela dobry film'),(5,5,10,'this review is coming from postman EVEN MORE'),(8,3,9,'It is ok, could be worse'),(9,2,9,'It is bad, could be better');
...
INSERT INTO `user` VALUES (1,'GreenGoblin75','joe.doe@gmail.com','$2a$10$M/F4fFQQ87fahvYNy0xZ/uCDDW64GULARhJWnsqPE0vP0gqqGEEeO',_binary ''),(2,'DocOc1258','peter.small@gmail.com','$2a$10$3t1N726EDSoKStaNYTjbVudx5QBKSTcjBJDQz2ojMwF0i5TJnz0ja',_binary '\0'),(3,'BigKarelPrague','karel@gmail.com','wlmlemkvmfef548',_binary '\0'),(4,'lucie48','lucie.small@seznam.cz','fe;m,velmlvre51',_binary ''),(5,'ThisComesFromPostmanUPDATED','HELLOTHERE@gmail.com','$2a$10$8sgg4Be6SYajYu/MIrXI7eCMhLGYqYo7cKknlJE3c3j6.GHu9UCIC',_binary '');
...
-- Dump completed on 2021-12-31  1:55:53
